...
<h3>Current Version: <strong><em>v0.33</em></strong></h3>
<ul>
  <li>Added doors with locks.</li>
  <li>Protal functionality implemented</li>
  <li>Added 3rd level to level system.</li>
</ul>
