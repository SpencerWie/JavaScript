...
function Sprite(scene, imageFile, width, height){ 
  ...
  this.distanceTo = function(sprite){
      ...
      myX = this.x //+ (this.width/2); TEST COMPLETE, bug fixed. This was testing the left corner and not center. w or h /2 must have been doubled on.
...
function Scene(){
	...
	this.canvas.id = 'Canvas'; //Change Here Made//
